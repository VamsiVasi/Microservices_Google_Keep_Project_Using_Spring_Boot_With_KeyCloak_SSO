...
# _Configure KeyCloak With Spring Boot_

Step 1 : **_Keycloak_** Dependency should be added along with **_Spring Security_** Dependency.
* **_Keycloak_** Dependency for **_Maven_** :
```javascript
<dependency>
...
```
* **_Keycloak_** Dependency for **_Gradle_** :
```javascript
implementation 'org.keycloak:keycloak-spring-boot-starter:15.0.2'
```

Step 2 : **_application.properties_** for Spring Boot :
```javascript
keycloak.auth-server-url=http://localhost:<Keycloak_Port>/auth
keycloak.realm=<Realm_Name>
keycloak.resource=<Client_Id>
keycloak.credentials.secret=<Client_Secret>
```

# _KeyCloak Configuration With Spring Security_
...
public class KeycloakSecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/keep/Create/User-Note").permitAll()
